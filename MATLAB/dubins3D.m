function [ data, g, data0 ] = dubins3D(accuracy)
% dubins3D: demonstrate the 3D aircraft collision avoidance example
%
%   [ data, g, data0 ] = dubins3D(accuracy)
%  
%%
% In this example, the target set is a circle at the origin (cylinder in 3D)
% that represents the Dubins car colliding with an obstacle where a steers
% to avoid the obstacle while b disturbs antagonistically
%
...
% $Id: dubins3D.m 74 2012-07-04 21:27:00Z mitchell $
...
% dubins3DHamFunc: analytic Hamiltonian for 3D collision avoidance example.
%
% hamValue = dubins3DHamFunc(t, data, deriv, schemeData)
%
...
% dubins3DPartialFunc: Hamiltonian partial fcn for 3D collision avoidance example.
%
% alpha = dubins3DPartialFunc(t, data, derivMin, derivMax, schemeData, dim)
%
